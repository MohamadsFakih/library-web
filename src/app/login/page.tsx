...
function LoginForm() {
  ...
  // Show error from URL (NextAuth adds ?error=CredentialsSignin on failure)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex">
      <div
        className="hidden lg:flex lg:w-[40%] relative overflow-hidden flex-col items-center justify-center p-12"
        style={{ background: "linear-gradient(145deg, #1e3a8a 0%, #2563eb 50%, #3b82f6 100%)" }}
      >
        <div className="relative z-10 max-w-xs text-center">
          <div className="w-16 h-16 rounded-2xl bg-white/15 backdrop-blur flex items-center justify-center mx-auto mb-8">
          ...
          <p className="text-white/80 text-sm">Borrow books, manage your reads, and discover new titles.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-[var(--background)]">
        <div className="w-full max-w-sm animate-slide-up">
          ...
          <p className="text-[var(--muted)] text-sm mb-6">Sign in to your account</p>
            ...
            <div className="space-y-2 mb-6">
              {hasGoogle && (
                <button
                  ...
                  className="btn btn-outline w-full rounded-xl py-3 text-sm font-medium flex items-center justify-center gap-2"
                >
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-xs"><span className="bg-[var(--background)] px-2 text-[var(--muted)]">Or</span></div>
              </div>
            </div>
          )}
